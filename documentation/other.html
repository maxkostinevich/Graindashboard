                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div id="animation-spin" class="mb-5">
                                <h2 class="h4">Animation Spin <a class="anchorjs-link" href="#animation-spin" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tab-content bg-lighter" id="pills-tabContent-1">
                                        <div class="tab-pane fade p-4 show active" id="pills-result-1" role="tabpanel" aria-labelledby="pills-result-tab-1">
                                            <a class="btn-width-sm btn btn-lg btn-primary mb-2 mr-2" href="#">
                                                <i class="gd-reload icon-text animation-spin align-middle"></i>
                                            </a>
                                        </div>
...
&lt;/a&gt;
                            ...
                            <div id="cursor" class="mb-9">
                                <h2 class="h4">Cursor <a class="anchorjs-link" href="#cursor" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
...
.cursor-pointer {
    cursor: pointer;
                            ...
                            <div id="opacity" class="mb-9">
                                <h2 class="h4">Opacity <a class="anchorjs-link" href="#opacity" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
...
.opacity-md {
    opacity: .7;
                            ...
                            <div id="overflow" class="mb-9">
                                <h2 class="h4">Overflow <a class="anchorjs-link" href="#overflow" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
...
.overflow-inherit {
    overflow: inherit !important;
                            ...
                            <div id="font-sizes" class="mb-9">
                                <h2 class="h4">Font sizes <a class="anchorjs-link" href="#font-sizes" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
...
.font-size-inherit {
    font-size: inherit !important;
                            ...
                            <div id="font-weight" class="mb-9">
                                <h2 class="h4">Font weight <a class="anchorjs-link" href="#font-weight" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
