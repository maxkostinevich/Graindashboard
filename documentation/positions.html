    ...
    <div class="content">
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <div class="h3 mb-0">Positions</div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div id="centering" class="mb-9">
                                <h2 class="h4">Centering <a class="anchorjs-link" href="#centering" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                <p>Assuming the parent element has <code>position: relative;</code>, these properties will center a child element both horizontally and vertically inside, no matter what the width of height of either are.</p>
...
<code class="language-markup" data-lang="html">
  ...
  &lt;/div&gt;
                                ...
                                <div class="alert alert-warning mb-3" role="alert">
                                    ...
                                    <p class="alert-text mb-0">Although beware if the child element being centered is taller than parent, the top could get cut off.</p>
                                </div>
                            </div>
                        </div>
                    </div>
