    ...
    <div class="content">
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <div class="h3 mb-0">Transitions</div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="border-bottom pb-3 mb-6">
                                <p class="lead">CSS transitions allows you to change property values smoothly (from one value to another), over a given duration.</p>
                            </div>
